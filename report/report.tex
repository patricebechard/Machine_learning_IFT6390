...
Enfin, un arbre de décision sera construit afin de classer les spectres. Cette approche est similaire à celle conduite par \cite{ball2006robust}, qui visait à classifier des objets célestes en catégories plus grandes (étoile, galaxie ou QSO) à l'aide d'arbres de décision .
