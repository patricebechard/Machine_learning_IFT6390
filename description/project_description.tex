...
\title{IFT6390 - Proposition de projet final}
...
\item Reseau de neurones convolutif
\end{enumerate}

\section{datasets}
\begin{enumerate}
\item SDSS (Comparer etoiles (type spectral) ou objet celeste(etoile, galaxie, QSO))
\item ECG et maladies(\url{http://www.cs.cmu.edu/~bobski/data/data.html})
\end{enumerate}
